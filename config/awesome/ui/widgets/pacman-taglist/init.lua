...
local get_taglist = function(s)
    ...
    local ghost = gears.surface.load_uncached(gfs.get_configuration_dir() .. "ui/widgets/pacman-taglist/assets/ghost.png")
    local ghost_icon = gears.color.recolor_image(ghost, beautiful.xcolor6)
    local dot = gears.surface.load_uncached(gfs.get_configuration_dir() .. "ui/widgets/pacman-taglist/assets/dot.png")
    local dot_icon = gears.color.recolor_image(dot, beautiful.xcolor8)
    local pacman = gears.surface.load_uncached(gfs.get_configuration_dir() .. "ui/widgets/pacman-taglist/assets/pacman.png")
        ...
        widget_template = {
            ...
            create_callback = function(self, c3, index, objects)
                ...
                self:connect_signal('mouse::leave', function()
                    awesome.emit_signal("bling::tag_preview::visibility", s, alse)
                end)
            end,
