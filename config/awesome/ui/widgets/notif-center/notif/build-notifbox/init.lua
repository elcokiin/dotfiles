...
local empty_notifbox = require("ui.widgets.notif-center.notif.build-notifbox.empty-notifbox")
local notifbox_scroller = require("ui.widgets.notif-center.notif.build-notifbox.notifbox-scroller")
...
local notifbox_add = function(n, notif_icon, notifbox_color)
	...
	local notifbox_box = require("ui.widgets.notif-center.notif.build-notifbox.notifbox-builder")
...
naughty.connect_signal("request::display", function(n)
	...
	if not notif_icon then
		notif_icon = beautiful.theme_assets.awesome_icon(24, beautiful.xcolor8, beautiful.widget_bg)
	end
