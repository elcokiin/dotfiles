...
local control_center_toggle = require("ui.widgets.hamburger")
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ mod, shift }, "s", function()
		awful.spawn.with_shell(apps.custom.spotify)
	end, { description = "open notion", group = "app custom" }),

	-- Notion
	awful.key({ mod, shift }, "n", function()
		awful.spawn.with_shell(apps.custom.notion)
	end, { description = "open notion", group = "app custom" }),

	-- RemNote
	awful.key({ mod, shift }, "r", function()
		awful.spawn.with_shell(apps.custom.rem_note)
	end, { description = "open rem-note", group = "app custom" }),

	-- Brave
	awful.key({ mod, shift }, "b", function()
		awful.spawn.with_shell(apps.custom.brave)
	end, { description = "open web brave", group = "app custom" }),

	-- Planner
	awful.key({ mod, shift }, "p", function()
		awful.spawn.with_shell(apps.custom.planner)
	end, { description = "open planner", group = "app custom" }),

	-- Custom keybindings

	awful.key({ mod }, "c", function()
		control_center:toggle()
	end, { description = "toggle control center", group = "keybindings custom" }),
	awful.key({ mod }, "d", function()
		dashboard:toggle()
	end, { description = "toggle dashboard center", group = "keybindings custom" }),
	awful.key({ mod }, "y", function()
		awesome.emit_signal("widget::systray:toggle")
	end, { description = "toggle systray", group = "keybindings custom" }),
	---- WM
	---------
	-- Restart awesome
	...
	-- Music
	awful.key({ctrl, shift}, "k", function()
