...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "open web firefox", group = "launcher" }),
	...
	awful.key({ modkey, shift }, "n", function()
		awful.spawn.with_shell(notion)
	end, { description = "open notion", group = "launcher" }),
	awful.key({ modkey, shift }, "r", function()
		awful.spawn.with_shell(remNote)
	end, { description = "open rem-note", group = "launcher" }),
	awful.key({ modkey, shift }, "b", function()
		awful.spawn.with_shell(brave)
	end, { description = "open web brave", group = "launcher" }),
	awful.key({ modkey, shift }, "p", function()
		awful.spawn.with_shell(planner)
	end, { description = "open planner", group = "launcher" }),
})
